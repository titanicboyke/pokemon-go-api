    ...
    public static function load(): array
    {
        return [
            TranslationParser::ENGLISH  => [
                ...
                'raidgraphic_header_weather' => 'Boosted',
                'raidgraphic_header_cprange' => 'CP-Range',
                'raidgraphic_header_counter' => 'Counters',
                'raidgraphic_header_difficulty' => 'Spelers',
                'raidgraphic_header_description' => <<<'HTML'
                    <p><span class="circle mode-hard">Rood</span> Optimaal vanaf lvl 40 en Bestfriends Bonus<br/></p>
                    <p><span class="circle mode-normal">Geel</span> Optimaal vanaf lvl 30 en Hyperfriends Bonus<br/></p>
                    <p><span class="circle mode-easy">Groen</span> Optimaal vanaf lvl 20 zonder Friends Bonus<br/></p>
                    HTML,
                'raidgraphic_footer_line' => 'www.catchemall.be',
            ],
